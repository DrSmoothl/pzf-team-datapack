scoreboard players add @a[team=!BCR,team=!ACG,team=!CTEC,team=!DPI,team=!ELS,team=!GRU,team=!HCN,team=!LAS,team=!TOG,team=!TUT,team=!UBB,team=!XGC,team=!Yun_Xiu] team-time 1
...
execute as @a[scores={team-time=600}] at @s run function team:tp_no_team_player
